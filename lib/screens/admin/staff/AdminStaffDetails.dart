...
class _StaffDetailsScreenState extends State<StaffDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBarWidget(title: widget.staff.title,),
                      ...
                      Positioned(
                        ...
                        child: ClipRRect(
                          child: CircleAvatar(
                            radius: 70.0,
                            backgroundImage:
                            widget.staff.photo == null || widget.staff.photo == "" ? NetworkImage(InfixApi.root + "public/uploads/staff/demo/staff.jpg") : NetworkImage(InfixApi.root + widget.staff.photo),
